...
<div>
    <x-input-label for="precio_venta" value="Precio de venta (USD) *" />
...
<div>
    <x-input-label for="nombre_comprador" value="Nombre del comprador *" />
...
<div>
    <x-input-label for="telefono_comprador" value="Teléfono del comprador *" />
...
<div class="sm:col-span-2">
    <x-input-label for="notas_venta" value="Notas" />
