<div class="bg-white shadow rounded-xl p-4 sm:p-6">
    ...
    @if ($mostrandoFormulario)
        <form wire:submit="guardar" class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 bg-gray-50 border border-gray-200 rounded-xl p-4">
            ...
            <div>
                <x-input-label for="monto" value="Monto (USD) *" />
            ...
            <div class="sm:col-span-2">
                ...
                <x-text-input id="descripcion" type="text" class="mt-1 block w-full" wire:model="descripcion" placeholder="Cambio de pastillas de freno" />
    ...
    <div class="mt-4 divide-y divide-gray-100">
                ...
                <div class="flex items-center gap-2">
                    ...
                    @if (auth()->user()->hasRole('admin') || ($gasto->user_id === auth()->id() && $this->puedeRegistrar()))
                        ...
                        <button wire:click="eliminar({{ $gasto->id }})"
                                wire:confirm="¿Eliminar este gasto de {{ dinero($gasto->monto) }}?"
        ...
        @empty
            <p class="py-3 text-sm text-gray-500">Sin gastos registrados.</p>
        @endforelse
    </div>
</div>
