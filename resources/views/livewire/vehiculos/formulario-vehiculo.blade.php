<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form wire:submit="guardar" class="bg-white shadow rounded-xl p-4 sm:p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                <x-input-label for="vin" value="VIN (17 caracteres) *" />
            ...
            <div>
                <x-input-label for="millas" value="Millas *" />
            ...
            <div>
                <x-input-label for="precio_compra" value="Precio de compra (USD) *" />
            ...
            <div>
                <x-input-label for="lugar_compra" value="Lugar de compra *" />
            ...
            <div>
                <x-input-label for="estado_titulo" value="Estado del título *" />
            ...
            <div class="sm:col-span-2">
                ...
                <textarea id="notas" rows="3" wire:model="notas"
                          class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm text-base"
                          placeholder="Observaciones de la compra, daños, etc."></textarea>
            ...
            <div class="sm:col-span-2 flex flex-wrap gap-3 justify-end pt-2">
                ...
                <button type="submit"
                    ...
                    <span wire:loading.remove wire:target="guardar">{{ $vehiculo ? 'Guardar cambios' : 'Registrar vehículo' }}</span>
